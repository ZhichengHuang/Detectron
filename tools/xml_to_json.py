...
def addImgItem(file_name,size):
    ...
    pre,suf=image_name.split(".")[0].split("-")
    id,id1=pre.split('_')
    id2,id3 = pre.split('_')
    image_id = int(id+id1+id2+id3)
    image_item = dict()
...
if __name__=="__main__":
    xml_path="/teamscratch/msra-msm/v-zhihua/food/data/test/"
    json_file="/teamscratch/msra-msm/v-zhihua/food/data/annotations/test.json"
